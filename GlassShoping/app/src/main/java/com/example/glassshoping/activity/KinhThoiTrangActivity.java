...
import com.example.glassshoping.adapter.KinhRamAdapter;
import com.example.glassshoping.adapter.KinhThoiTrangAdapter;
...
public class KinhThoiTrangActivity extends AppCompatActivity {
    Toolbar toolbar;
    ...
    KinhThoiTrangAdapter kinhCanAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kinh_thoi_trang);
                        ...
                        sanPhamModel -> {
                            if(sanPhamModel.isSuccess()){
                                if(kinhCanAdapter==null){
                                    ...
                                    kinhCanAdapter = new KinhThoiTrangAdapter(getApplicationContext(), sanPhamList);
    ...
    private void Anhxa() {
        toolbar= findViewById(R.id.toolbarkinhthoitrang);
        recyclerView = findViewById(R.id.recycleview_kinhthoitrang);
