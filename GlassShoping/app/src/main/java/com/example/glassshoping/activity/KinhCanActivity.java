...
import com.example.glassshoping.adapter.KinhCanAdapter;
...
public class KinhCanActivity extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kinh_can);
                        ...
                        sanPhamModel -> {
                                if(sanPhamModel.isSuccess()){
                                    if(kinhCanAdapter==null){
                                        ...
                                        kinhCanAdapter = new KinhCanAdapter(getApplicationContext(), sanPhamList);
    ...
    private void Anhxa() {
        toolbar= findViewById(R.id.toolbarkinhcan);
        recyclerView = findViewById(R.id.recycleview_kinhcan);
