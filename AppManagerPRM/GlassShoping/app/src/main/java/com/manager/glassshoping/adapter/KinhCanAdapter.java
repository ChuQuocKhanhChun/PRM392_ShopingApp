...
public class KinhCanAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public KinhCanAdapter(Context context, List<SanPham> array) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if(viewType == VIEW_TYPE_DATA){
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_kinhcan,parent,false);
    ...
    public class MyviewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyviewHolder(@NonNull View itemView){
            super(itemView);
            tensp = itemView.findViewById(R.id.itemkc_ten);
            giasp = itemView.findViewById(R.id.itemkc_gia);
            mota = itemView.findViewById(R.id.itemkc_mota);
            hinhanh = itemView.findViewById(R.id.itemkc_image);
            idsp = itemView.findViewById(R.id.itemkc_id);
