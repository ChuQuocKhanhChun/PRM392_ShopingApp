...
import com.manager.glassshoping.Interface.IImangeClickListener;
import com.manager.glassshoping.R;
import com.manager.glassshoping.model.EventBus.TinhTongEvent;
...
public class GioHangAdapter extends RecyclerView.Adapter<GioHangAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull GioHangAdapter.MyViewHolder holder, int position) {
        ...
        holder.cbxcheck.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            cbxcheck = itemView.findViewById(R.id.cbx_giohang_check);
            //eventclick
